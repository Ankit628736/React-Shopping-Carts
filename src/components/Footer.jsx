      ...
      <div className="container">
        <div className="row g-4">
            ...
            <div className="mb-4">
              ...
              <div className="contact-info">
                ...
                <p className="d-flex align-items-center mb-3 contact-item">
                  ...
                  <span>singh.ankit9871@gmail.com</span>
                </p>
                <p className="d-flex align-items-center mb-3 contact-item">
          ...
          <div className="col-lg-8">
            ...
            <div className="map-container shadow-lg" style={{
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d68533.86522336105!2d75.6228964692393!3d31.267263260150756!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391a5f6f5b06fb59%3A0x156b2b86806e1ffe!2slovely%20professional%20university%20main%20food%20court!5e0!3m2!1sen!2sin!4v1727799784552!5m2!1sen!2sin"
                style={{
                  width: '100%',
                  height: '300px',
                  border: '0'
        ...
        <div className="text-center mt-5">
          <p className="mb-0 text-white-50">
            Made with <FaHeart style={{color: '#FF5252'}}/> by Ankit Raj © {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
